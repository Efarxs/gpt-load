export default {
  ...
  keys: {
    ...
    clearInvalidKeysShort: "Clear Invalid Keys",
    clearAllKeys: "Clear All Keys",
    clearAllKeysShort: "Clear All Keys",
    pauseGroup: "Pause Group",
    enableGroup: "Enable Group",
    paused: "Paused",
    confirmPauseGroup: "Paused groups return HTTP 403 to clients. Pause \"{name}\"?",
    confirmEnableGroup: "Enable group \"{name}\"?",
    ...
    testResultTitle: "Upstream Probe Response",
    testResultStatus: "Result",
    testResultPassed: "Passed",
    testResultFailed: "Failed",
    testResultHttpStatus: "HTTP Status",
    testResultDuration: "Duration",
    testResultError: "Reason",
    testResultBody: "Upstream Response Body",
    testResultEmptyBody: "(empty body)",
    testResultCopyBody: "Copy Body",
    testResultClose: "Close",
    ...
    modelParamOverrides: "Model Param Overrides",
    modelParamOverridesTooltip:
      "Override outbound parameters by model name after protocol conversion. See the placeholder for the JSON shape. Use an asterisk to match all models.",
    modelParamOverridesDescription:
      "Format: model name to a parameter object. Applied after protocol conversion. An asterisk matches all models.",
    modelParamOverridesInvalid: "Invalid model param overrides: each model must map to an object",
  ...
  logs: {
    ...
    upstreamRequestContent: "Upstream Request Body",
  ...
  footer: {
    ...
    viewSource: "View this repository",
    feedback: "Feedback",
    reportIssue: "Report Issue",
    contributors: "Contributors",
    viewContributors: "View Contributors",
    upstream: "Upstream",
    viewUpstream: "Original repository tbphp/gpt-load",
    forkNote: "optimized fork",
