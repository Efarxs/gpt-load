export default {
  ...
  keys: {
    ...
    clearInvalidKeysShort: "異常キーをクリア",
    clearAllKeys: "すべてのキーをクリア",
    clearAllKeysShort: "すべてのキーをクリア",
    pauseGroup: "グループを一時停止",
    enableGroup: "グループを有効化",
    paused: "一時停止中",
    confirmPauseGroup: "一時停止中のグループはクライアントに 403 を返します。「{name}」を一時停止しますか？",
    confirmEnableGroup: "グループ「{name}」を有効にしますか？",
    ...
    testResultTitle: "上流プローブ応答",
    testResultStatus: "判定",
    testResultPassed: "成功",
    testResultFailed: "失敗",
    testResultHttpStatus: "HTTP ステータス",
    testResultDuration: "所要時間",
    testResultError: "理由",
    testResultBody: "上流レスポンス本文",
    testResultEmptyBody: "（本文なし）",
    testResultCopyBody: "本文をコピー",
    testResultClose: "閉じる",
    restoreKey: "キーを復元",
    ...
    modelParamOverrides: "モデルパラメータ上書き",
    modelParamOverridesTooltip:
      "プロトコル変換後にモデル名ごとに出方向パラメータを上書きします。形式は入力欄のプレースホルダーを参照。アスタリスクですべてのモデルに一致します。",
    modelParamOverridesDescription:
      "形式：モデル名 → パラメータオブジェクト。プロトコル変換後に上流へ書き込みます。アスタリスクですべてのモデルに一致します。",
    modelParamOverridesInvalid: "モデルパラメータ上書きの形式が無効です。各モデルはオブジェクトである必要があります",
  ...
  footer: {
    ...
    viewSource: "このリポジトリを見る",
    feedback: "フィードバック",
    reportIssue: "問題を報告",
    contributors: "貢献者",
    viewContributors: "貢献者を見る",
    upstream: "原プロジェクト",
    viewUpstream: "上流リポジトリ tbphp/gpt-load",
    forkNote: "二次開発・最適化版",
    joinGroup: "グループに参加",
  },
  charts: {
