export default {
  ...
  keys: {
    ...
    clearInvalidKeysShort: "清空异常密钥",
    clearAllKeys: "清空所有密钥",
    clearAllKeysShort: "清空全部密钥",
    pauseGroup: "暂停分组",
    enableGroup: "启用分组",
    paused: "已暂停",
    confirmPauseGroup: "暂停后该分组代理将返回 403，确定要暂停「{name}」吗？",
    confirmEnableGroup: "确定要启用分组「{name}」吗？",
    ...
    testResultTitle: "上游探测响应",
    testResultStatus: "判定",
    testResultPassed: "通过",
    testResultFailed: "未通过",
    testResultHttpStatus: "HTTP 状态",
    testResultDuration: "耗时",
    testResultError: "原因",
    testResultBody: "上游响应正文",
    testResultEmptyBody: "（无响应正文）",
    testResultCopyBody: "复制正文",
    testResultClose: "关闭",
    restoreKey: "恢复密钥",
    ...
    modelParamOverrides: "模型参数覆盖",
    modelParamOverridesTooltip:
      "按模型名覆盖出站参数，在协议转换之后生效。示例见输入框占位符。星号可匹配全部模型。",
    modelParamOverridesDescription:
      "格式：模型名 → 参数对象。在协议转换之后写入上游请求。星号可匹配全部模型。",
    modelParamOverridesInvalid: "模型参数覆盖格式无效：每个模型必须对应一个对象",
  ...
  logs: {
    ...
    requestContent: "请求内容",
    upstreamRequestContent: "发给上游的请求体",
    errorInfo: "错误信息",
    customColumns: "自定义列",
  },
  settings: {
  ...
  footer: {
    ...
    upstream: "原项目",
    viewUpstream: "查看原仓库 tbphp/gpt-load",
    forkNote: "二次开发优化版",
    joinGroup: "加入群组",
  },
  charts: {
