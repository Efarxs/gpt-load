    ...
    <div class="footer-container">
      ...
      <div class="footer-main">
        <span class="project-info">
          <a href="https://github.com/Efarxs/gpt-load" target="_blank" rel="noopener noreferrer">
            <b>GPT-Load</b>
          </a>
        </span>
        ...
        <div class="links-container">
          ...
          <n-tooltip trigger="hover" placement="top">
            <template #trigger>
              <a
                href="https://github.com/Efarxs/gpt-load"
                target="_blank"
                rel="noopener noreferrer"
                class="footer-link"
              >
          ...
          <n-tooltip trigger="hover" placement="top">
            <template #trigger>
              <a
                href="https://github.com/Efarxs/gpt-load/issues"
                target="_blank"
                rel="noopener noreferrer"
                class="footer-link"
              >
          ...
          <n-tooltip trigger="hover" placement="top">
            <template #trigger>
              ...
              >
                ...
                <span>{{ t("footer.upstream") }}</span>
              </a>
            </template>
            {{ t("footer.viewUpstream") }}
          </n-tooltip>
        ...
        <div class="copyright-container">
          ...
          <span class="license-text">MIT · {{ t("footer.forkNote") }}</span>
        </div>
      </div>
    </div>
  </footer>
