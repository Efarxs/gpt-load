...
type GroupCreateRequest struct {
	...
	ModelParamOverrides map[string]any      `json:"model_param_overrides"`
...
func (s *Server) CreateGroup(c *gin.Context) {
	...
	params := services.GroupCreateParams{
		...
		ModelParamOverrides: req.ModelParamOverrides,
...
type GroupResponse struct {
	...
	ModelParamOverrides datatypes.JSONMap   `json:"model_param_overrides"`
...
func (s *Server) newGroupResponse(group *models.Group) *GroupResponse {
	...
	return &GroupResponse{
		...
		ModelParamOverrides: group.ModelParamOverrides,
